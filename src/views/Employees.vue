              ...
              <td :colspan="headers.length">
                ...
                <v-card-title class="text--secondary">
                  ...
                  <v-card-text>
                    ...
                    <v-row>
                      <v-col>CIN : {{item.cin}} </v-col>
                      <v-col>Date de naissance : {{item.d_naissance}}</v-col>
                      <v-col>Qualification : {{item.qulification}} </v-col>
                    </v-row>

                    <v-row>
                      <v-col>Date embauche : {{item.embauche_date}} </v-col>
          ...
          >
            ...
            <v-card>
              ...
              <v-card-title class="headline grey lighten-2">
                ...
                <span v-else>Création d'un nouveau utilisateur</span>
                <v-spacer></v-spacer>
                  <v-btn
                  icon
              ...
              <v-row>
                  ...
                  <v-col>
                    <v-text-field
                      ...
                      dense
                      outlined
                      v-model="editedItem.d_naissance"
                  ...
                  <v-col>
                    <v-text-field
                      ...
                      dense
                      outlined
                      v-model="editedItem.qulification"
                      label="Qulification"
                    ></v-text-field>
                  </v-col>
                  <v-col>
                    <v-text-field
                      ...
                      dense
                      outlined
                      v-model="editedItem.embauche_date"
                      label="Date Embauche"
                    ></v-text-field>
                  </v-col>
...
export default {
  ...
  data() {
    return {
      headers: [
        ...
        { text: "Nom Complet", value: "full_name", width: "200", sortable: true },
        ...
        { text: "CIN", value: "cin", width: "70", sortable: true },
        { text: "Action", value: "actions", sortable: true, width: "100" },
      ],
      roles: ['responsable', 'chefeq','client'],
      items: [],
      dialog: false,
      editedItem: {},
      error: "",
  ...
  methods: {
    ...
    loadItems() {
      ...
      const url = process.env.VUE_APP_API_ENDPOINT + "/api/Users/getemp";
      axios
        .get(url, {
