        ...
        <v-card>
          ...
          >
            ...
            <template v-slot:item.operations="{ item }">
              ...
              <div class="text-truncate">
                <v-btn rounded outlined text @click="sendtop(item.id)"> Rapport </v-btn>
              </div>
            </template>
          ...
          <v-dialog v-if="role!='client'" v-model="dialog" max-width="500px">
            <template v-slot:activator="{ on }">
              <div class="d-flex">
                <v-btn v-if="role!='client'" color="primary" dark class="ml-auto ma-3" v-on="on">
                  New
...
export default {
  ...
  methods: {
    ...
    loadItems() {
      ...
      const idd = this.$store.getters.getUser.id;
      axios
        .get(`http://139.99.238.74:8000/api/clientmission/getclientmission/`+idd, {
