      ...
      <v-row align="center" justify="center">
        <v-col cols="10">
          <v-card style="width: 100%">
            <h1 class="text-center pt-6 font-weight-light display-2">Nos Projets</h1>
              ...
              <v-col class="col-12 col-sm-6 col-md-4">
                <div class="flex-center">
                  <v-card-text>
                    ...
                    <div class="text--disabled text-uppercase text-h5 my-2">Projet1</div>
                    <v-divider class="my-2"/>
                    <div class="text-uppercase blue--text">Projet 2</div>
                    <v-divider class="my-2"/>
